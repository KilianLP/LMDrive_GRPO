...
class Blip2VicunaDrive(Blip2Base):
    ...
    def __init__(
        ...
        vit_precision="fp16",
        freeze_vit=True,
        freeze_waypoints_predictor=True,
        freeze_end_predictor=True,
        freeze_qformer=True,
        ...
        if self.has_gru_decoder:
            ...
            if freeze_waypoints_predictor:
                for name, param in self.waypoints_fc.named_parameters():
                    param.requires_grad = False
                for name, param in self.waypoints_predictor.named_parameters():
                    param.requires_grad = False
                for name, param in self.waypoints_output.named_parameters():
                    param.requires_grad = False
        else:
        ...
        if freeze_end_predictor:
            for name, param in self.end_predictor.named_parameters():
                param.requires_grad = False
